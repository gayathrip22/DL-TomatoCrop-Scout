load('F:\Shell_Intern\Shell_Project\TrainData_Matlab\trainedModelraw.mat');
...
layer = 'dense2';
featuresTrain7 = activations(trainedModelraw,augimdsTrain,layer,'OutputAs','rows');
featuresTest7 = activations(trainedModelraw,augimdsTest,layer,'OutputAs','rows');
...
[YPred, scores] = classify(trainedModelraw, augimdsTest);
