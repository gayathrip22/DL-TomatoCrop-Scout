load('F:\Shell_Intern\Shell_Project\TrainData_Matlab\trainedModelAug.mat');
...
layer = 'dense2';
featuresTrain7 = activations(trainedModelAug,augimdsTrain,layer,'OutputAs','rows');
featuresTest7 = activations(trainedModelAug,augimdsTest,layer,'OutputAs','rows');
...
[YPred, scores] = classify(trainedModelAug, augimdsTest);
