load('F:\Shell_Intern\Shell_Project\TrainData_Matlab\trainedModelprimeAug.mat');

data = 'F:\Shell_Intern\Shell_Project\Data images\Augmented_images';
...
layer = 'fc3';
featuresTrain7 = activations(trainedModelprimeAug,augimdsTrain,layer,'OutputAs','rows');
featuresTest7 = activations(trainedModelprimeAug,augimdsTest,layer,'OutputAs','rows');
...
[YPred, scores] = classify(trainedModelprimeAug, augimdsTest);
