...
% Train the network
trainedModelprimeAug = trainNetwork(augimdsTrain, layers, options);

% Save the trained model to a MAT file
save(fullfile('F:\Shell_Intern\Shell_Project\TrainData_Matlab\trainedModelprimeAug'), 'trainedModelprimeAug');